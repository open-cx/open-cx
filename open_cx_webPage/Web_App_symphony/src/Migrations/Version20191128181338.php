 ...
 */
final class Version20191128181338 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE presentation (id INT AUTO_INCREMENT NOT NULL, id_speaker1 INT DEFAULT NULL, id_speaker2 INT DEFAULT NULL, id_speaker3 INT DEFAULT NULL, id_room INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, summary VARCHAR(255) DEFAULT NULL, start_time DATETIME DEFAULT NULL, end_time DATETIME DEFAULT NULL, hashtag VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
