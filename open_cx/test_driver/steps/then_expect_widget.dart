...
class ThenExpectWidget extends Then2WithWorld<String, String, FlutterWorld> {

  ThenExpectWidget() : super(StepDefinitionConfiguration()..timeout = Duration(seconds: 10));
